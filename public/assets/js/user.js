...
async function doSignup() {
  ...
  if (!isValidEmail(identifier) && !isValidPhone(identifier)) {
    msg.innerHTML = `<span style="color:red">Enter valid Email OR Phone.</span>`;
    return;
  }
...
async function doLogin() {
  ...
  if (!identifier || !password) {
    msg.innerHTML = `<span style="color:red">Enter Email/Phone & Password.</span>`;
    return;
  }

  if (!isValidEmail(identifier) && !isValidPhone(identifier)) {
    msg.innerHTML = `<span style="color:red">Invalid Email or Phone.</span>`;
    return;
  }
